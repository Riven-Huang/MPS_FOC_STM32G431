...
如果你是在更换电机、减速器或编码器安装方式，请同时参考 [`适配新电机的标准流程.docx`](./适配新电机的标准流程.docx) 与根目录 [`README.md`](../README.md) 里的“新电机适配流程”章节。
...
如果是新电机适配，请优先按 [`适配新电机的标准流程.docx`](./适配新电机的标准流程.docx) 的顺序完成参数收集、编码器对齐和电流环 bring-up，再回到本节逐项核对。
